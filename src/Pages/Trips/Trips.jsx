...
const Trips = () => {
 ...
 <PackageContent title={"Family Wildlife Adventure"} img1={fam1} img2={fam2} img3={fam3} img4={fam4} description={"Bring your family on a journey filled with discovery. This package includes guided safaris, cultural experiences, and accommodations tailored for all ages. Spot wildlife, learn local traditions, and enjoy evenings by the campfire-ideal for creating shared memories in Kenya's stunning landscapes"} logo={logo} price={"Ksh 10000 for a family of 4 for 5 days/4 nights"} offerPrice={"Free activity pack for kids under 12"} />
 ...
 price={"Ksh 10,000 per person for 5 days/4 nights"} offerPrice={"ksh 1000 donated to conservation per booking"} />
